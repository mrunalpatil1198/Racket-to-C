;performed registerization on the interpreter by replacing let* expressions with begin blocks, converting let* bindings into set! expressions, adapting serious functions to accept no arguments, and defining global registers using define-registers.
#lang racket
